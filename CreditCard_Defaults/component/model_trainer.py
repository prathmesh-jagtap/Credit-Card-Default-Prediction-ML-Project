...
from CreditCard_Defaults.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from CreditCard_Defaults.entity.config_entity import ModelTrainerConfig
from CreditCard_Defaults.util.util import load_numpy_array_data, save_object, load_object
from CreditCard_Defaults.entity.model_factory import MetricInfoArtifact, ModelFactory, GridSearchedBestModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            logging.info(
                f"Splitting training and testing input and target feature")
