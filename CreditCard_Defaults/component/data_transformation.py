...
from CreditCard_Defaults.entity.config_entity import DataTransformationConfig
from CreditCard_Defaults.constant import *
from CreditCard_Defaults.util.util import read_yaml_file, save_object, save_numpy_array_data, load_data
from CreditCard_Defaults.entity.artifact_entity import (
...
class DataTransformation:
    ...
    def __del__(self):
        logging.info(
            f"{'='*20}Data Transformation log completed.{'='*20} \n\n")
