...
from CreditCard_Defaults.entity.config_entity import ModelEvaluationConfig
from CreditCard_Defaults.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact, ModelTrainerArtifact, ModelEvaluationArtifact
from CreditCard_Defaults.constant import *
from CreditCard_Defaults.util.util import write_yaml_file, read_yaml_file, load_object, load_data
...
class ModelEvaluation:
    ...
    def __init__(self, model_evaluation_config: ModelEvaluationConfig,
        ...
        try:
            logging.info(
                f"{'>>' * 30}Model Evaluation log started.{'<<' * 30} ")
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            logging.info(
                f"Conversion completed target column into numpy array.")
            ...
            logging.info(
                f"Dropping target column from the dataframe completed.")
